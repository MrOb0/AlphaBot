...
client.on("guildChannelTopicUpdate", (channel, oldTopic, newTopic) => {
    ...
    const LogChannel = client.channels.cache.get('959107112166912010'); 
...
client.on("guildChannelPermissionsUpdate", (channel, oldPermissions, newPermissions) => {
    ...
    const PermissionUpdate = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<#${channel.id}>'s permissions updated!"`);
...
client.on("unhandledGuildChannelUpdate", (oldChannel, newChannel) => {
    ...
    const unhandledGuildChannelUpdate = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription("Channel '" + oldChannel.id + "' smh");
...
client.on("guildMemberRoleAdd", (member, role) => {
    ...
    const MemberRoleAdd = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}> got the role \`${role.name}\``);
...
client.on("guildMemberRoleRemove", (member, role) => {
    ...
    const MemberRoleRemove = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}> lost the role \`${role.name}\``);
...
client.on("guildMemberNicknameUpdate", (member, oldNickname, newNickname) => {
    ...
    const MemberNicknameUpdate = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}> changed nickname from \`${oldNickname}\` to \`${newNickname}\``);
...
client.on("guildMemberOffline", (member, oldStatus) => {
    ...
    const MemberOffline = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}> became offline!`);
...
client.on("guildMemberOnline", (member, newStatus) => {
    ...
    const MemberOnline = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}>  was offline and is now ${newStatus} + !`);
...
client.on("rolePermissionsUpdate", (role, oldPermissions, newPermissions) => {
    ...
    const RolePermissionUpdated = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(role.name + " had as permissions " + oldPermissions.name + " and now has as permissions " + newPermissions.name);
...
client.on("userAvatarUpdate", (user, oldAvatarURL, newAvatarURL) => {
    ...
    const AvatarUpdated = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${user.id}> updated avatar from [Old Avatar](${oldAvatarURL}) to [New Avatar(${newAvatarURL})]`);
...
client.on("userUsernameUpdate", (user, oldUsername, newUsername) => {
    ...
    const Username = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${user.id}> updated thier username from ${oldUsername} to ${newUsername}`);
...
client.on("userDiscriminatorUpdate", (user, oldDiscriminator, newDiscriminator) => {
    ...
    const Discriminator = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${user.id}> updated thier discriminator from ${oldDiscriminator} to ${oldDiscriminator}`);
...
client.on("userFlagsUpdate", (user, oldFlags, newFlags) => {
    ...
    const FlagsUpdate = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${user.id}> updated thier flags from ${oldFlags} to ${newFlags}`);
...
client.on("voiceChannelJoin", (member, channel) => {
    ...
    const VCJoined = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}> Joined ${channel}`);
...
client.on("voiceChannelLeave", (member, channel) => {
    ...
    const VCLeft = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}> Left ${channel}`);
...
client.on("voiceChannelSwitch", (member, oldChannel, newChannel) => {
    ...
    const VCSwitch = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}> left <#${oldChannel.id}> and joined <#${newChannel.id}>`);
...
client.on("voiceChannelMute", (member, muteType) => {
    ...
    const VCMute = new MessageEmbed()
        .setTitle('User Muted')
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}>` + " became muted! (type: " + muteType + ")");
...
client.on("voiceChannelUnmute", (member, oldMuteType) => {
    ...
    const VCUnmute = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}> became unmuted!`);
...
client.on("voiceChannelDeaf", (member, deafType) => {
    ...
    const VCDeafen = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}> become deafed!`);
...
client.on("voiceChannelUndeaf", (member, deafType) => {
    ...
    const VCUndeafen = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}>` + " become undeafed!");
...
client.on("voiceStreamingStart", (member, voiceChannel) => {
    ...
    const UserStreaming = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}>` + " started streaming in " + voiceChannel.name);
...
client.on("voiceStreamingStart", (member, voiceChannel) => {
    ...
    const UserStoppedStreaming = new MessageEmbed()
        ...
        .setColor('#2F3136')
        .setDescription(`<@${member.user.id}>` + " stopped streaming in " + voiceChannel.name);
